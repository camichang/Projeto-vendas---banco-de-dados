...
app.get("/produtos", (req, res)=>{
var dbURL = "mongodb+srv://camila_chang:camila_chang@cluster0.gcljv.mongodb.net/vendas?retryWrites=true&w=majority";

mongoose.connect(dbURL);

mongoose.connection.on('connected', function () {
    console.log('conexão aberta ' + dbURL);
    mongoose.connection.db.collection('produtos').count(function (err, count) {
        console.dir(err);
        console.dir(count);
        ...
        if (count == 0) {
            ...
            // console.log("dados cadastrado " + count)
